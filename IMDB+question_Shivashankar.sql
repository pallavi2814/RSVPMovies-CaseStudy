...
FROM   genre; 
-- Total 13 genres in the dataset
-- Movies belongs to these 13 unique genres.
...
-- Total number of movies produced for drama is 4285 which is the highest among all genres. 
...
-- Dream Warrior Pictures and National Theatre Live production houses has produced the most number of hit movies and They have rank=1 and movie count =3
-- It's ok if RANK() or DENSE_RANK() is used too
...
GROUP  BY genre
ORDER  BY movie_count DESC;
-- 24 Drama movies were released during March 2017 and it had more than 1000 votes
...
-- All the movies belong to the genres Drama, Horror ,Crime, Mystery and Action
-- There are 12 movies which begin with "The"
...
--  Movies released between 1 April 2018 and 1 April 2019 with a median rating of 8 are 361
...
GROUP BY country;
-- YES German has more votes than Italian movies
-- Answer is Yes
...
GROUP BY production_company
LIMIT 2;
-- Highest number of hits among multilingual movies came from Star Cinema and Twentieth Century Fox.
